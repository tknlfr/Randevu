...
<admin-working-item day="tuesday"   @add="add" title="Sali"        :data="tuesday">   </admin-working-item>
<admin-working-item day="wednesday" @add="add" title="Carsamba"    :data="wednesday"> </admin-working-item>
<admin-working-item day="thursday"  @add="add" title="Persembe"    :data="thursday">  </admin-working-item>
